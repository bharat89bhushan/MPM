	...
	$this->widget('zii.widgets.grid.CGridView', array(
        ...
        'columns'=>array(
        	...
        	'qty',
                array(
                        'class'=>'CButtonColumn'
			, 'viewButtonUrl'=>'Yii::app()->createUrl("/ArticleProcessDetails/view", array("id"=>$data["id"]))'
            , 'updateButtonUrl'=>'Yii::app()->createUrl("/ArticleProcessDetails/update", array("id"=>$data["id"]))'
            , 'deleteButtonUrl'=>'Yii::app()->createUrl("/ArticleProcessDetails/delete", array("id"=>$data["id"]))'
